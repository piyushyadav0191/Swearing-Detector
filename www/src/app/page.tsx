...
export default async function Home() {
  ...
  return (
    <div className="bg-blue-200">
        ...
        <div className="mx-auto max-w-7xl pb-24 pt-10 sm:grid lg:grid-cols-2 sm:pb-32 lg:gap-x-8 lg:px-8 lg:pt-32 lg:pb-52">
          <div className="px-6 lg:px-0 lg:pt-4">
            <div className="mx-auto max-w-lg text-center sm:text-left flex flex-col items-center lg:items-start">
              ...
              Detecting harmful content has historically been{" "}
                <span
                  className={cn(
                ...
                . But that's changing. Presenting a rapid, complimentary, and open-source cursing filter for your web applications.
              </p>

              <ul className="mt-8 space-y-2 font-medium flex flex-col items-center sm:items-start">
                <div className="space-y-2">
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-red-500" /> Boasts
                    faster and more cost-effective operation than AI.
                  </li>
                  <li className="flex gap-1.5 items-center">
                    <Check className="h-5 w-5 shrink-0 text-red-500" />{" "}
                    Demonstrates impressive accuracy.
                  </li>
                  <li className="flex gap-1.5 items-center">
                    <Check className="h-5 w-5 shrink-0 text-red-500" />{" "}
                    Available entirely free of charge and open-source.
                  </li>
                </div>
              </ul>
      ...
      <section className="bg-yellow-200  px-4">
        <div className="mx-auto max-w-6xl gap-6 pb-24 pt-20 sm:pb-32 lg:gap-x-8 lg:px-8 lg:py-40">
          <div className="w-full flex flex-col">
            ...
            <p className="text-center mx-auto mt-12 text-lg max-w-xl text-balance">
              <span className="font-semibold">
                Moderating cursing is a thankless job.
              </span>{" "}
      ...
      <section id="video-demo" className="bg-blue-50 grainy-light">
        <div className="mx-auto max-w-6xl gap-6 pb-24 pt-10 sm:pb-32 lg:gap-x-8 lg:px-8 lg:py-40">
          ...
          <p className="text-center mx-auto mt-12 text-lg max-w-xl text-balance">
            ...
            Let Cursed Detector API do the dirty work of keeping your user input clean.
          </p>
          ...
          >
            ...
            <div className="relative max-w-4xl w-full text-left p-5 bg-[#1e1e1e] rounded-xl shadow">
              <CodeSection />
            </div>
          </div>
        </div>
